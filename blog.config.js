...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'The Ultimate Guide to Wood Splitting Swords: Tips, Techniques, and Reviews🎉',
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://woodsplittingsword.lownrain.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Wood splitting sword', // 网站关键词 英文逗号隔开
